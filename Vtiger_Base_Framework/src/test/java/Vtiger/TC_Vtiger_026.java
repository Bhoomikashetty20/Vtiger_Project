...
public class TC_Vtiger_026 extends Base_Test {
	
	@DataProvider
	public String[] sendData() {
		String[] opt= {"14578","14","@!##$%","Bhoomi123","123@!#","Bhoomi23!@"};
		return opt;
	}
	
	@Test(dataProvider = "sendData")
	public void toEnterDataToEmployees(String data) {
		CreateLead_Page lead=new CreateLead_Page(driver);
		Lead_Page leadPage=new Lead_Page(driver);
		lead.getLeads().click();
		leadPage.getCreateLeadIcon().click();
		WebElement noOfEmployees = lead.getNoOfEmployees();
		noOfEmployees.sendKeys(data);
