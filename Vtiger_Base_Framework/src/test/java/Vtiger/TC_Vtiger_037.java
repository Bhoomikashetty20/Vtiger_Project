...
public class TC_Vtiger_037 extends Base_Test {
	
	@DataProvider
	public String[] sendData() {
		String[] opt= {"India","1234567","India@!@#","@#$%^&*","India3421"};
		return opt;
	}
	
	@Test(dataProvider = "sendData")
	public void toEnterDataToCountryTextField(String data) {
		CreateLead_Page lead=new CreateLead_Page(driver);
		Lead_Page leadPage=new Lead_Page(driver);
		lead.getLeads().click();
		leadPage.getCreateLeadIcon().click();
		WebElement countryTextField = lead.getCountryTextField();
		countryTextField.sendKeys(data);
