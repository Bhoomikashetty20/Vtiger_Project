...
public class TC_Vtiger_036 extends Base_Test{
	
	@DataProvider
	public String[] sendData() {
		String[] opt= {"Bangalore","1234567","Bangalore@!@#","@#$%^&*","Bangalore3421","14"};
		return opt;
	}
	
	@Test(dataProvider = "sendData")
	public void toEnterDataToPostalTextField(String data) {
		CreateLead_Page lead=new CreateLead_Page(driver);
		Lead_Page leadPage=new Lead_Page(driver);
		lead.getLeads().click();
		leadPage.getCreateLeadIcon().click();
		WebElement postalTextField = lead.getPostalCodeTextField();
		postalTextField.sendKeys(data);
